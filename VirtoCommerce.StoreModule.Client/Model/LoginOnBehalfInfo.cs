...
namespace VirtoCommerce.StoreModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LoginOnBehalfInfo :  IEquatable<LoginOnBehalfInfo>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LoginOnBehalfInfo {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LoginOnBehalfInfo);
        }

        /// <summary>
        /// Returns true if LoginOnBehalfInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of LoginOnBehalfInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoginOnBehalfInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
